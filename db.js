...
// Si existe DATABASE_URL (Render, Railway, Supabase, etc.), la usamos.
// Si no, usamos las variables sueltas (para desarrollo local en tu PC).
const usaUrlDeConexion = Boolean(process.env.DATABASE_URL);

const pool = usaUrlDeConexion ?
    new Pool({
